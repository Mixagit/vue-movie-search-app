export const movieModule = {
    state: () => ({
        movies: [
            { id: 1, name: "movie 1", desc: "desc 1" },
            { id: 2, name: "movie 2", desc: "desc 2" },
            { id: 3, name: "movie 3", desc: "desc 3" },
            { id: 4, name: "movie 4", desc: "desc 4" },
            { id: 5, name: "movie 5", desc: "desc 5" },
            { id: 6, name: "movie 6", desc: "desc 6" },
        ],
